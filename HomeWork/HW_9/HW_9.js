...
block.innerText = "original block";
...
clonedBlock.innerText = "cloned block";
...
coursesAndDurationArray.forEach(course => {
    ...
    durationP.classList.add('description');
    durationP.innerText = `Duration: ${course.monthDuration} months`;

    itemDiv.appendChild(titleH1);
    itemDiv.appendChild(durationP);
...
coursesArray.forEach(course => {
    ...
    let modulesTitleP = document.createElement('p');
    modulesTitleP.innerText = 'Modules:';
    modulesDiv.appendChild(modulesTitleP);
